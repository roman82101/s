...
echo "... Редактирование и случайная сортировка списка user_agents ..."
...
echo "... Создание и случайная сортировка списка с сайтами ..."
cat >> /root/noisy/tmp_sites <<'EOF'
        "https://4chan.org",
        "https://4pda.ru",
        "https://airly.org",
        "https://airmq.by",
...
EOF
echo "... Слияние user_agents и tmp_config ..."
sed -e '/Intel Mac OS X 10_11_6/r./user_agents' config > tmp_config
echo "... Слияние sites и tmp_config ..."
sed -e '/2ip.ru/r./sites' tmp_config > config.json
rm -f user_agents.txt tmp1 tmp2 config user_agents tmp_sites sites tmp_config
: ' #Закомментировано
